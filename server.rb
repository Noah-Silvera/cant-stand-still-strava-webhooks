# Adapted from an example in the strava-ruby-client repo https://raw.githubusercontent.com/dblock/strava-ruby-client/master/bin/strava-webhooks
...
when 'create' then
  ...
  subscription = client.create_push_subscription(callback_url: callback_url, verify_token: ENV["WEBHOOK_TOKEN"])
  puts subscription
when 'delete'
  id = ARGV[1]
